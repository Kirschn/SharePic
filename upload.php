        ...
        function startDrop() {
            ...
            uploader.on("success", function (file, response) {
               console.log(response);
                ...
                document.getElementsByClassName("dz-filename")[0].innerHTML = "<br>Share this link with your friends: <a href='/" + response +"'>sharepic.tk/"+response+"</a><br>or this one if you want the raw image:  <a href='/" + response +"/raw'>sharepic.tk/"+response+"/raw</a>";
                uploader.disable();
            });
